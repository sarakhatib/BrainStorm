...
public partial class OurSongs : System.Web.UI.Page
{
    ...
    protected void FillGridView()
    {
        ...
        if (Session["User"] != null && GridViewSongs.EditIndex==-1)
        {
    ...
    protected void GridViewSongs_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        Label SongID = (Label)GridViewSongs.Rows[GridViewSongs.EditIndex].FindControl("LabelSongID");
        TextBox SongArtist = (TextBox)GridViewSongs.Rows[GridViewSongs.EditIndex].FindControl("TextBoxEditArtist");
        TextBox YouTubeLink = (TextBox)GridViewSongs.Rows[GridViewSongs.EditIndex].FindControl("TextBoxEditYouTubeLink");
        DropDownList Rate = (DropDownList)GridViewSongs.Rows[GridViewSongs.EditIndex].FindControl("DropDownListEditRate");
        TextBox Album = (TextBox)GridViewSongs.Rows[GridViewSongs.EditIndex].FindControl("TextBoxAlbum");
